...
(function(a){
	...
	const settings = {
		  ...
		  TEXTILE_SCALE_MODE: PIXI.SCALE_MODES.LINEAR,
...
*/
	 ...
	 */
	class TextileResource extends PIXI.resources.Resource{
...
//		          const res = tex.resource as any;
	...
	TILEJS["TextileResource"] = TextileResource;
	...
	TILEJS["TilemapShader"] = TilemapShader;


	class TilemapGeometry extends PIXI.Geometry{
		  vertSize = 13;
		  vertPerQuad = 4;
		...
		TILEJS["TilemapGeometry"] = TilemapGeometry;
	...
	TILEJS["TileRenderer"] = TileRenderer;


	/* eslint-disable no-unused-vars */
	POINT_STRUCT = {"U":0, "V":1, "X":2, "Y":3, "TILE_WIDTH":4, "TILE_HEIGHT":5, "ROTATE":6, "ANIM_X":7, "ANIM_Y":8, "TEXTURE_INDEX":9, "ANIM_COUNT_X":10, "ANIM_COUNT_Y":11, "ANIM_DIVISOR":12, "ALPHA":13,};
	...
	class Tilemap extends PIXI.Container{
		   ...
		   */
		  tilemapBounds = new PIXI.Bounds();

		  /** Flags whether any animated tile was added. */
		  hasAnimatedTile = false;
		  ...
		  tile(tileTexture, x, y, options = {}){
		      ...
		      if (typeof tileTexture === 'number'){
		          ...
		          if (typeof tileTexture === 'string'){
		              texture = PIXI.Texture.from(tileTexture);
		          } else {
		              texture = tileTexture;
		          }
...
//		  getLocalBounds(rect?)
		  ...
		  addFrame(texture, x, y, animX, animY){
			  this.tile(texture,x,y,{animX,animY,});
		    return true;
		  }
		  ...
		  {
		      return this.tile(textureIndex, x, y, {u, v, tileWidth, tileHeight, animX, animY, rotate, animCountX, animCountY, animDivisor, alpha});
		  }
	}

	TILEJS["Tilemap"] = Tilemap;
	...
	TILEJS["CanvasTileRenderer"] = CanvasTileRenderer;
	...
	//	          if ((layers[i] as Tilemap).isModified(anim))
		...
		//          (layers[i] as Tilemap).clearModify();
		  ...
		  addFrame(texture, x, y, animX, animY, animWidth, animHeight, animDivisor, alpha){
		      return this.tile(texture, x, y, {animX, animY, animCountX, animCountY, animDivisor, alpha});
		  }
...
//	TILEJS["CompositeTilemap"] as CompositeRectTileLayer } from './CompositeTilemap';
/*
	console.log(PIXI.extensions);
	PIXI.System.extensions.add({
		  name: 'tilemap',
		  type: ExtensionType.RendererPlugin,
//		  ref: TileRenderer as any
	});
*/	
	TILEJS["CompositeTilemap"] = CompositeTilemap;
